...
- [ ] **A Record:** `pt24.pro` → Your server IP
- [ ] **A Record:** `www.pt24.pro` → Your server IP
- [ ] **DNS Propagation:** Completed (verify with `dig pt24.pro`)
...
- [ ] Website is accessible at https://pt24.pro
