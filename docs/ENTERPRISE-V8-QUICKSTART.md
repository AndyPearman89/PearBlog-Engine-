# PearBlog Engine Enterprise v8 Quickstart

## Introduction
This document provides a quickstart guide to setting up PearBlog Engine Enterprise v8.
...
- [ ] Confirm Enterprise v8 is enabled (PEARBLOG_ADMIN_VERSION / pearblog_admin_version set to v8-enterprise)
...
Refer to the official PearBlog documentation for more comprehensive details about installation and configuration.